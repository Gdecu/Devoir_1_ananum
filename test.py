...
T = np.array([
    [7.9844, 3.3522, 5.5397, 3.6478, 0.0000, 0.0000, 0.0000],
    [3.3522, 7.6823, 4.7740, 5.1340, 6.3571, 0.0000, 0.0000],
    [5.5397, 4.7740, 6.2887, 9.5223, 7.1730, 0.1630, 0.0000],
    [3.6478, 5.1340, 9.5223, 9.1620, 1.4160, 2.4289, 1.5668],
    [0.0000, 6.3571, 7.1730, 1.4160, 6.0697, 1.3723, 4.0094],
    [0.0000, 0.0000, 0.1630, 2.4289, 1.3723, 8.0418, 1.2979],
    [0.0000, 0.0000, 0.0000, 1.5668, 4.0094, 1.2979, 1.0881]
])
